...
page_title: "eon_backup_vaults Data Source - terraform-provider-eon"
subcategory: ""
description: |-
...
- `vaults` (Attributes List) List of backup vaults. (see [below for nested schema](#nestedatt--vaults))
