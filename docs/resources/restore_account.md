...
- `updated_at` (String) Time at which Terraform last applied a change to this restore account. Eon does not report an update timestamp, so this records the local apply time and is not refreshed afterwards.
