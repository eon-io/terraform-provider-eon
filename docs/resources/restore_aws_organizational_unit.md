...
page_title: "eon_restore_aws_organizational_unit Resource - terraform-provider-eon"
subcategory: ""
description: |-
  Connects a restore AWS organizational unit to the Eon project. All AWS accounts within the organizational unit (and its nested OUs) are automatically discovered and available as restore targets.
...
# eon_restore_aws_organizational_unit (Resource)
...
- `created_at` (String) Date and time the restore AWS organizational unit was connected to the Eon project.
...
- `updated_at` (String) Date and time the restore AWS organizational unit was last updated.
