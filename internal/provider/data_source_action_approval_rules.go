				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							MarkdownDescription: "Server-assigned unique identifier of the rule.",
							Computed:            true,
						},
						"operation": schema.StringAttribute{
							MarkdownDescription: "Protected operation. Possible values: `ADD_RESTORE_ACCOUNT`, `CREATE_BACKUP_POLICY`, `RESTORE_RESOURCE`, `UPDATE_BACKUP_POLICY`, `DELETE_BACKUP_POLICY`, `REMOVE_SNAPSHOT_HOLD`.",
							Computed:            true,
						},
