...
func (d *ActionApprovalRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves a list of action approval rules (multi-party authorization rules) in the Eon project.",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"operation": schema.StringAttribute{
							MarkdownDescription: "Protected operation type.",
							Computed:            true,
						},
