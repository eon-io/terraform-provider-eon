...
func (d *IdpsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Retrieves a list of identity providers (IdPs) configured in the Eon account. An IdP ID is required input for `eon_idp_group` role assignments.",
